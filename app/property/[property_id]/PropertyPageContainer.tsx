...
export const PropertyPageView = observer(
  (props: { id: string; router: any }) => {
      ...
      <div>
        ...
        <div className="grid grid-cols-12 gap-4 mb-[82px]">
          <div className="col-span-8 p-4">
            ...
            <section className="p-[24px] rounded border border-[#D9DBE9] mb-[56px]">
                ...
                <div className="border-r border-r-[#D9DBE9] px-[40px]">
                  ...
                  <Typography type="h2" className="truncate">
                    {property?.internal_area_ft
                      ? `${property?.internal_area_ft} SqFt`
                      : '-'}
                  </Typography>
                </div>
                <div className="pl-[40px]">
                  <Typography type="info">Common Area</Typography>
                  <Typography type="h2" className="truncate">
                    {property?.external_area_ft
                      ? `${property?.external_area_ft} SqFt`
                      : '-'}
                  </Typography>
                </div>
              </div>
            ...
            <section className="mb-[56px]">
              ...
              <div className="w-[862px] h-[420px] bg-slate-200"></div>
            </section>
